...
Route::get('/books', 'BooksController@index')->name('books.show');
Route::get('/books/categories', 'BooksController@show')->name('categories.show');

Route::get('/books/categories/{slug}', 'CategoriesController@show')->name('books.index');
