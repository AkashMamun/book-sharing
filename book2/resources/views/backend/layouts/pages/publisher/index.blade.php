...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus-circle fa-sm text-white-50"></i> Add Publisher</a>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add New Publisherr</h5>
                ...
                <form action="{{ route('admin.publishers.store') }}" method="post">
                    ...
                    <div class=" row">
                        ...
                        <div class="col-md-6">
                            ...
                            <br>
                            <input type="text" class="form-control" name="link" placeholder="Publishre Link">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <br>
                            <input type="text" class="form-control" name="outlet" placeholder="Publishre Outlet">
                        </div>

                        <div class="col-12">
                            <label for="">PublisherDetails</label>
                            <br>
                ...
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-success" href="#editModal{{ $publisher->id }}" data-toggle="modal">
                                    <i class="fa fa-edit">Edit</i>
                                </a>
                                <a class="btn btn-danger" href="#deleteModal{{ $publisher->id }}" data-toggle="modal">
                                        ...
                                        <form action="{{ route('admin.publishers.update',$publisher->id) }}" method="post">
                                            ...
                                            <div class=" row">
                                                ...
                                                <div class="col-md-6">
                                                    <label for="">Publisher Link</label>
                                                    <br>
                                                    <input type="text" class="form-control" name="link" placeholder="Publishre Link" value="{{ $publisher->link }}">
                                                </div>
