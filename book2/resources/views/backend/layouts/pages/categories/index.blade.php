...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-toggle="modal" data-target="#addModal"><i class="fas fa-plus-circle fa-sm text-white-50"></i> Add Category</a>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.categories.store') }}" method="post">
                    ...
                    <div class=" row">
                        ...
                        <div class=" col-12">
                            <label for="">Categoryr Details</label>
                            <br>
                ...
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-success" href="#editModal{{ $category->id }}" data-toggle="modal">
