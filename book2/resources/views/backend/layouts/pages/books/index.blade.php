...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="{{ route('admin.books.create') }}" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm" data-target="#addModal"><i class="fas fa-plus-circle fa-sm text-white-50"></i> Add Book</a>
                ...
                <table class="table" id="dataTable">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class=" btn btn-success" href="#editModal{{ $book->id }}" data-toggle="modal">
                                    <i class="fa fa-edit"></i>
                                </a>
                                <a class="btn btn-danger" href="#deleteModal{{ $book->id }}" data-toggle="modal">
